...
@WebFilter(urlPatterns = {"/jsp/ngo-dashboard.jsp", 
        "/jsp/request-food.jsp",
        "/jsp/view-donation.jsp",
        "/jsp/track-requested-food.jsp"})

public class NgoAccessFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        if (session == null || session.getAttribute("roleId") == null) {
            ...
            if (roleId == 3) { // Ngo roleId
                // If the roleId is 3 (Ngo), allow access to user pages
