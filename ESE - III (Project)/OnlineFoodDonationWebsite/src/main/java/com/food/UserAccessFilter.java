...
@WebFilter(urlPatterns = {"/jsp/user-dashboard.jsp", 
        "/jsp/view-requested-food.jsp",
        "/jsp/voluntary-donate-food.jsp",
        "/jsp/donation-history.jsp"})
...
public class UserAccessFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        if (session == null || session.getAttribute("roleId") == null) {
            ...
            if (roleId == 2) { // User roleId
                // If the roleId is 2 (user), allow access to user pages
