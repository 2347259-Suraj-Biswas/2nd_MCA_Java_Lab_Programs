...
<head>
    ...
    <title>NGO List - Online Food Donation</title>
    <style>
...
<body>
    ...
    <div class="ngo-list-content">
        ...
        <table>
            ...
            <tbody>
                <!-- Fetch data from DbUtil and iterate over the list -->
                <% 
                    List<User> ngoList = DbUtil.getNgoUsers();
                    for (User user : ngoList) { 
                %>
                <tr>
                    <td><%= user.getNgoName() %></td>
